        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl border border-gray-100 p-6">
              <h3 className="font-bold text-[#1B1F3B] mb-5">Informations de contact</h3>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-[#1B1F3B]">contact@fasocademy.cmm</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-9 h-9 rounded-xl bg-[#FFF3E8] flex items-center justify-center shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-[#1B1F3B]">+226 64 71 20 44 ou +212 771 668 079</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-9 h-9 rounded-xl bg-[#FFF3E8] flex items-center justify-center shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-[#1B1F3B]">Ouagadougou, Burkina Faso</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-9 h-9 rounded-xl bg-[#FFF3E8] flex items-center justify-center shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-[#1B1F3B]">+226 64 71 20 44</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="bg-white rounded-2xl border border-gray-100 p-6">
              <h3 className="font-bold text-[#1B1F3B] mb-2">Support</h3>
              <p className="text-sm text-gray-500">La plateforme est accessible 24h/24, 7j/7.</p>
              <p className="text-sm text-gray-400 mt-2">Réponse garantie sous 24h ouvrables</p>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl border border-gray-100 p-8">
            {sent ? (
              <div className="flex flex-col items-center justify-center h-full py-12 text-center">
                ...
                <p className="text-gray-500">Nous avons bien reçu votre message et vous répondrons dans les 24 heures ouvrables.</p>
                <Button onClick={() => setSent(false)} variant="outline" className="mt-6">Envoyer un autre message</Button>
              </div>
            ) : (
              <>
                <h3 className="font-bold text-[#1B1F3B] text-xl mb-6">Envoyez-nous un message</h3>
